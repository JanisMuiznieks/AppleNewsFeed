...
class NewsFeedViewController: UIViewController {
    ...
    func handleGetData(){
        ...
        let jsonUrl =
            "http://newsapi.org/v2/everything?q=apple&from=2021-02-11&to=2021-02-11&sortBy=popularity&apiKey=426785172f6a46d18a6283d67806fde0"
        ...
        let task = session.dataTask(with: urlRequest) { (data, response, error) in
            ...
            do {
                if let dictData = try JSONSerialization.jsonObject(with: data, options: []) as? [String: Any] {print("dictData", dictData)
